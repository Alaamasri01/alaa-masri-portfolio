...
(function () {
  ...
  function tracer(x0, y0, x1, y1, w, h, o) {
    o = o || {};
    var pl = o.pad === undefined ? 6 : o.pad, pt = o.top === undefined ? 6 : o.top, reserve = o.reserve === undefined ? 24 : o.reserve;
  ...
  P.arcadeWall = function (w, h) {
    var T = tracer(470, 40, 1340, 665, w, h, { center: true }), X = T.X, Y = T.Y, s = '';
  ...
  P.archFamily = function (w, h) {
    ...
    var n = A.length, gap = 5, span = Math.min((w - 8 - gap * (n - 1)) / n * .74, 20), cell = (w - 8) / n, base = h - 28, s = '';
    ...
    A.forEach(function (a, i) {
      var cx = 4 + cell * i + cell / 2, x0 = cx - span / 2, x1 = cx + span / 2, sp = base - a[2] * span, ap = sp - a[3] * span;
  ...
  P.poolWall = function (w, h) {
    var T = tracer(470, 150, 1330, 640, w, h, { center: true, reserve: 26 }), X = T.X, Y = T.Y, s = '';
  ...
  P.nicheDetail = function (w, h) {
    var s = '', x = 8, top = 8, H = h - 34, depth = 16;
  ...
  P.skylineHeadboard = function (w, h, dark) {
    ...
    var T = tracer(830, 120, 1720, 810, w, h, { center: true }), X = T.X, Y = T.Y, s = '';
  ...
  P.skylinePlan = function (w, h, dark) {
    if (dark) P.theme(true);
    var s = '', X = 12, Y = 10, RW = w - 22, RH = h - 34, t = 2.2;
  ...
  P.villaElevation = function (w, h, o) {
    ...
    var T = tracer(200, 15, 1800, 850, w, h, { center: true, reserve: 26 }), X = T.X, Y = T.Y, R = T.R, s = '', slab = o.dark ? C.light : C.ink;
  ...
  P.screenDetail = function (w, h, dark) {
    ...
    s += P.caps(px + half - 9, py + 2, 'Plan', { size: 2.45, fill: C.mid });
    ...
    s += P.dim(px + 2, py + 21, px + 2 + (half - 16) / 7, py + 21, 'Fin rhythm', 4);
    s += P.label(px + 20, py + 13.5, px + 24, py + 8.5, 'Light line');
  ...
  P.gardenPlan = function (w, h) {
    var s = '', X = 10, Y = 8, RW = w - 20, RH = (h - 34) * .62, t = 2.4, GY = Y + RH + t;
    // room walls
  ...
  P.fireplaceWall = function (w, h) {
    var T = tracer(0, 0, 1800, 1000, w, h, { center: true, reserve: 32 }), X = T.X, Y = T.Y, R = T.R, s = '';
  ...
  P.gardenSection = function (w, h) {
    var s = '', g = h - 30, x0 = 8, ih = Math.min(58, g - 14), rw = w * .46;
  ...
  P.salonWall = function (w, h) {
    var T = tracer(560, 0, 1260, 810, w, h, { center: true, reserve: 32 }), X = T.X, Y = T.Y, R = T.R, s = '';
  ...
  P.majlisWall = function (w, h) {
    var T = tracer(840, 100, 1720, 760, w, h, { center: true, reserve: 32 }), X = T.X, Y = T.Y, R = T.R, s = '';
