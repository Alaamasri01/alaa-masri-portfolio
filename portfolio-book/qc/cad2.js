...
(function () {
  ...
  D.secMark = function (x, y, num, sheet, ang) {
    ...
    s += D.Tx(x, y - 1.3, num, { size: T.mark, anchor: 'middle', weight: 600 }) + D.Tx(x, y + 3.5, sheet, { size: 2.5, anchor: 'middle' });
    return s;
  };
  ...
  D.drawingTitle = function (w, num, sheet, title, sub) {
    var s = D.C(5.5, 5.5, 5.4, { w: W.sec }) + D.L(.1, 5.5, 10.9, 5.5, W.fix) + D.Tx(5.5, 4.2, num, { size: T.mark, anchor: 'middle', weight: 600 }) + D.Tx(5.5, 9, sheet, { size: 2.5, anchor: 'middle' });
